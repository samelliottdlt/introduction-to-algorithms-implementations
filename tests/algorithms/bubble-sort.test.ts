import algorithm from "../../src/algorithms/bubble-sort";

const bubbleSort = algorithm.algorithm;

describe("Bubble Sort", () => {
  it("should sort an array of numbers in ascending order", () => {
    expect(
      bubbleSort(["3", "2", "1"], (a, b) => Number(a) - Number(b)),
    ).toEqual(["1", "2", "3"]);
    expect(
      bubbleSort(["5", "4", "3", "2", "1"], (a, b) => Number(a) - Number(b)),
    ).toEqual(["1", "2", "3", "4", "5"]);
  });

  it("should handle an already sorted array", () => {
    expect(
      bubbleSort(["1", "2", "3", "4", "5"], (a, b) => Number(a) - Number(b)),
    ).toEqual(["1", "2", "3", "4", "5"]);
  });
  ...
  it("should sort an array of strings lexicographically", () => {
    expect(bubbleSort(["banana", "apple", "cherry"])).toEqual([
      "apple",
      "banana",
      "cherry",
    ]);
  ...
  it("should sort with a custom compare function", () => {
    ...
    expect(bubbleSort(["banana", "apple", "cherry"], customCompare)).toEqual([
      "cherry",
      "banana",
      "apple",
    ]);
  ...
  it("should parse arguments correctly", () => {
    ...
    expect(bubbleSort(input, compareFunction)).toEqual([
      "1",
      "2",
      "5",
      "8",
  ...
  it("should sort in ascending order by default", () => {
    ...
    expect(bubbleSort(input, compareFunction, ascending)).toEqual([
      "1",
      "2",
      "5",
      "8",
