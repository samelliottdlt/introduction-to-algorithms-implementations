import algorithm from "../../src/algorithms/insertion-sort";

const insertionSort = algorithm.algorithm;

describe("Insertion Sort", () => {
  it("should sort an array of numbers in ascending order", () => {
    expect(
      insertionSort(["3", "2", "1"], (a, b) => Number(a) - Number(b)),
    ).toEqual(["1", "2", "3"]);
    expect(
      insertionSort(["5", "4", "3", "2", "1"], (a, b) => Number(a) - Number(b)),
    ).toEqual(["1", "2", "3", "4", "5"]);
  });

  it("should handle an already sorted array", () => {
    expect(
      insertionSort(["1", "2", "3", "4", "5"], (a, b) => Number(a) - Number(b)),
    ).toEqual(["1", "2", "3", "4", "5"]);
  });
  ...
  it("should sort an array of strings lexicographically", () => {
    expect(insertionSort(["banana", "apple", "cherry"])).toEqual([
      "apple",
      "banana",
      "cherry",
    ]);
  ...
  it("should sort with a custom compare function", () => {
    ...
    expect(insertionSort(["banana", "apple", "cherry"], customCompare)).toEqual(
      ["cherry", "banana", "apple"],
    );
  });
  ...
  it("should parse arguments correctly", () => {
    ...
    expect(insertionSort(input, compareFunction)).toEqual([
      "1",
      "2",
      "5",
      "8",
  ...
  it("should sort in ascending order by default", () => {
    ...
    expect(insertionSort(input, compareFunction, ascending)).toEqual([
      "1",
      "2",
      "5",
      "8",
